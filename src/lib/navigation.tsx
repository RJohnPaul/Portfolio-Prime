...
const staticMenuItems: Array<Array<NavigationItem>> = [
	[
		...
		
		{
			type: NavigationItemType.LINK,
			icon: 'feather:link',
			text: 'My Own 3D Portfolio',
			href: 'https://john-paul.vercel.app',
			external: true,
		},
	],
	[
		{
			...
			icon: 'fe:mail',
			text: 'Get in touch',
			href: 'mailto:iamjohnpalr5@gmail.com?subject=lets%20develop%20a%20project%20together',
			external: true,
		},
		{
			type: NavigationItemType.LINK,
		...
		},
		{
			...
			icon: 'feather:file',
			text: 'Resume',
			href: 'https://drive.google.com/file/d/1rqBuXyVZmVqDWdcNG9kePc55sDb3dfbG/view?usp=sharing',
			external: true,
		},
	],
];
